...
#
title = "《心经》与现代生活"
start_time = Date.new(2017, 5, 27)
end_time = Date.new(2017, 5, 28)
speaker = "继持法师"
...
5.times do |event|
  Event.create(title: title, start_time: start_time, end_time: end_time, speaker: speaker, description: description, contact: contact, location: location, price: price)
end
